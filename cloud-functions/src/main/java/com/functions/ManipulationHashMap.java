...
public class ManipulationHashMap {
    ...
    public static interface WordCountOptions extends PipelineOptions {
        ...
        @Default.String("gs://bucket-new-bucket/NewRedis.txt")
        String getInputFile();
    ...
    public static void main(String[] args) {
        ...
        Manipulation.WordCountOptions options = PipelineOptionsFactory.fromArgs(args).withValidation()
                .as(Manipulation.WordCountOptions.class);
